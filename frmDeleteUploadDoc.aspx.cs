...
public partial class VehicleMaster_VehicleDoc1 : System.Web.UI.Page
{
    ...
    private void fetchDownload()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select * from SecureDocumentInfo where UploadById=@p1  ", con);
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["db"].ConnectionString);
        con.Open();
        SqlCommand cmd = new SqlCommand("Delete from SecureDocumentInfo where UploadById=@p1 and RequestId=@p2 ", con);
        cmd.Parameters.AddWithValue("@p1", Session["id"]);
