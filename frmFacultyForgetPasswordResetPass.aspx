<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFacultyForgetPasswordResetPass.aspx.cs" Inherits="Default2" %>
            ...
            <div class="forget-form" novalidate="novalidate" style="display: block;">
                ...
                <div class="form-group">
                    <div class="input-icon">
                        ...
                        <asp:TextBox id="txtForgotpwd" class="form-control placeholder-no-fix" autocomplete="off" placeholder="New Password" runat="server"  TextMode="Password"></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Reset Password" class="btn green-haze " OnClick="Button1_Click1"/>
