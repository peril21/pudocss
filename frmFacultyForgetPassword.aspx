<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmFacultyForgetPassword.aspx.cs" Inherits="Default2" %>
            ...
            <div class="forget-form" novalidate="novalidate" style="display: block;">
                ...
                <div class="form-group">
                    <div class="input-icon">
                        ...
                        <asp:TextBox id="txtForgotpwd" class="form-control placeholder-no-fix" autocomplete="off" placeholder="Enter MobileNo" runat="server"></asp:TextBox>
                        

                    </div>
                    <span id="rfvForgotpwd" style="color:Red;display:none;">Enter MobileNo</span>
                    <span id="revForgotpwd" style="color:Red;display:none;">Please Enter Valid MobileNo</span>
                </div>
                <div class="row">
