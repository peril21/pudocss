<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeFile="dltAllStudentAchivement.aspx.cs" EnableEventValidation = "false" Inherits="EnquiryStatus" %>
         ...
         <table style="width: 100%; height: 383px;">
             ...
             <tr>
                 <td class="style135" colspan="3" style="text-align: left">
                     All Faculty Assign Task Detail Info:<asp:Label ID="Label3" runat="server" Text="Label"></asp:Label>
                 </td>
             </tr>
             <tr>
                 <td colspan="3">
