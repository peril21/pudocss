<%@ Page Title="" Language="C#" MasterPageFile="~/ArtistMasterPage.master" AutoEventWireup="true" CodeFile="frmDeleteUploadDoc.aspx.cs" Inherits="VehicleMaster_VehicleDoc1" %>
                    ...
                    <tr>
                        ...
                        <td >
                            <table>
                                <tr>
                                    <td >
                                        <strong>Delete  Necessary Document:</strong></td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <tr>
                                                <td class="style14">
                                                    <asp:GridView ID="GridView1" runat="server" BackColor="White"  AutoGenerateSelectButton="true"
                                                        ...
                                                        onselectedindexchanged="GridView1_SelectedIndexChanged" EmptyDataText="No Record Found">
